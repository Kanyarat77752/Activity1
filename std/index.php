...
<body>
      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
            <img src="assets/img/student.jpg" alt="Profile" class="rounded-circle">
 ...
 <img src="assets/img/p.png" width="1190" height="670" alt="Bootstrap" class="d-none d-sm-block  mx-auto mb-30"> 
